...
const MobileFeaturesPage = () => {
  return (
    <FeaturePageTemplate
      ...
      description="Access mobile-specific features and functionality"
      icon={Smartphone}
    >
      <div className="p-6">
        <div className="text-center py-12">
          ...
          <h2 className="text-2xl font-semibold text-gray-800 mb-4">Mobile App Features</h2>
          <p className="text-gray-600 mb-8 max-w-2xl mx-auto">
            Access mobile-specific features and functionality
          </p>
