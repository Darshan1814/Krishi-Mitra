...
const EcommercePage = () => {
  ...
  const [farmerToFarmerItems, setFarmerToFarmerItems] = useState([
    { id: 1, name: 'Organic Wheat Seeds', image: 'https://images.unsplash.com/photo-1523348837708-15d4a09cfac2?w=300', location: 'Nashik, Maharashtra', date: '15 January 2025', price: '₹45/kg', contact: '+91 98765 43210' },
    { id: 2, name: 'Fresh Tomatoes', image: 'https://images.unsplash.com/photo-1592924357228-91a4daadcfea?w=300', location: 'Pune, Maharashtra', date: '22 February 2025', price: '₹30/kg', contact: '+91 87654 32109' },
    { id: 3, name: 'Basmati Rice', image: 'https://images.unsplash.com/photo-1586201375761-83865001e31c?w=300', location: 'Aurangabad, Maharashtra', date: '8 March 2025', price: '₹80/kg', contact: '+91 76543 21098' },
    { id: 4, name: 'Green Chillies', image: 'https://images.unsplash.com/photo-1583258292688-d0213dc5a3a8?w=300', location: 'Solapur, Maharashtra', date: '14 April 2025', price: '₹60/kg', contact: '+91 65432 10987' },
    { id: 5, name: 'Onions', image: 'https://images.unsplash.com/photo-1518977676601-b53f82aba655?w=300', location: 'Satara, Maharashtra', date: '3 May 2025', price: '₹25/kg', contact: '+91 54321 09876' },
    { id: 6, name: 'Sugarcane', image: 'https://images.unsplash.com/photo-1571771019784-3ff35f4f4277?w=300', location: 'Kolhapur, Maharashtra', date: '19 June 2025', price: '₹35/kg', contact: '+91 43210 98765' },
    { id: 7, name: 'Cotton Seeds', image: 'https://images.unsplash.com/photo-1605000797499-95a51c5269ae?w=300', location: 'Nagpur, Maharashtra', date: '24 July 2025', price: '₹120/kg', contact: '+91 32109 87654' },
    { id: 8, name: 'Grapes', image: 'https://images.unsplash.com/photo-1537640538966-79f369143f8f?w=300', location: 'Sangli, Maharashtra', date: '11 August 2025', price: '₹90/kg', contact: '+91 21098 76543' },
    { id: 9, name: 'Soybean', image: 'https://images.unsplash.com/photo-1612198188060-c7c2a3b66eae?w=300', location: 'Latur, Maharashtra', date: '27 September 2025', price: '₹55/kg', contact: '+91 10987 65432' },
    { id: 10, name: 'Maize', image: 'https://images.unsplash.com/photo-1551754655-cd27e38d2076?w=300', location: 'Ahmednagar, Maharashtra', date: '5 October 2025', price: '₹28/kg', contact: '+91 09876 54321' }
  ]);
          ...
          {userFlows.map((flow) => (
            <div key={flow.id} className="bg-white rounded-2xl shadow-xl overflow-hidden hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
              ...
              <div className="p-8">
                ...
                <Link
                  to={`/products/${flow.id === 1 ? 'farmer-to-farmer' : flow.id === 2 ? 'farmer-to-business' : 'business-to-farmer'}`}
